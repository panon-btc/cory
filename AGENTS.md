...
Language-specific guidelines are in separate files:
- `docs/AGENTS.rust.md` — Rust, Cargo, crate design
- `docs/AGENTS.ts.md` — TypeScript, React, Vite (the `crates/cory/ui/` SPA)
...
## Common failure modes when helping: The XY problem
